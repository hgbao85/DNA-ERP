  ...
  return [
    {
      ...
      lines: [
        { id: 111, itemName: 'Ráp khung tựa', spec: 'J55-TUA', needQty: 500, doneQty: 500, perManh: 1, thucCoQty: 0, lastInputAt: minsAgo(35) },
        { id: 121, itemName: 'Ráp chân ghế', spec: 'J55-CHAN', needQty: 500, doneQty: 320, perManh: 1, thucCoQty: 140, lastInputAt: minsAgo(80) },
        { id: 131, itemName: 'Hàn giằng ngang', spec: 'J55-GIANG', needQty: 1000, doneQty: 250, perManh: 2, thucCoQty: 300, lastInputAt: minsAgo(20) },
      ],
    },
    {
...
export default function LenhSanXuatHan({ readOnly = false }: { readOnly?: boolean }) {
  return <TwoTierScreen cfg={CFG} seed={seed} readOnly={readOnly} stage="HAN" />
}
