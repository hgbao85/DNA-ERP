...
const MOCK_REJECTED_LINES: Record<number, RejectedPackagingLine[]> = {
  4: [
    { uid: 99, maBB: 'BB-THUNG-99', unit: 'thùng', moTa: 'Thùng carton 3 lớp', imageUrl: '', submittedAt: '19/06/2026 10:30:00', lyDo: 'Thùng 3 lớp không đủ độ bền — theo quy định cần dùng thùng 5 lớp cho sản phẩm này' },
  ],
}
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 13 }}>
              <thead>
                <tr style={{ background: '#fff5f5', borderBottom: '1px solid #ffcdd2' }}>
                  {['Mã bao bì', 'ĐVT', 'Mô tả', 'Gửi lúc', 'Lý do từ chối'].map((h, i) => (
