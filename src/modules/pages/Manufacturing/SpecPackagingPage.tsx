...
export default function SpecPackagingPage() {
  ...
  // Lọc tasks thuộc SPEC_PACKAGING từ các proposal
              ...
              <div style={{ background: 'var(--surface)', padding: 16, borderRadius: 8 }}>
                ...
                <div style={{ marginBottom: 16 }}>
                  <label>
                    ...
                    <input value={form.unit ?? ''} onChange={e => setForm(f => ({ ...f, unit: e.target.value }))} placeholder="VD: thùng, bao, túi" style={{ padding: 8, border: '1px solid var(--border)', borderRadius: 6, width: '100%' }} />
                  </label>
                </div>
