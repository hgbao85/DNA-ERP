...
import { TwoTierScreen, SON_CFG, ISO, minsAgo, type ProcRow } from '../../../components/sanxuat/core'
  ...
  return [
    {
      ...
      lines: [{ id: 111, itemName: 'Sơn đen tĩnh điện', spec: 'SN-DEN-01', needQty: 120, doneQty: 60, thucCoQty: 45, lastInputAt: minsAgo(70) }],
    },
    {
      ...
      lines: [{ id: 211, itemName: 'Sơn xám tĩnh điện', spec: 'SN-XM-001', needQty: 60, doneQty: 0, thucCoQty: 20, lastInputAt: null }],
    },
    {
      id: 3, poNumber: 'PO-2026-003', sku: 'BAN-TB45', productName: 'Bàn TB-45 (vuông)',
      soLuong: 120, deadline: ISO(5), arrangedAt: null,
      lines: [{ id: 311, itemName: 'Sơn đen tĩnh điện', spec: 'SN-DEN-01', needQty: 40, doneQty: 0, thucCoQty: 0, lastInputAt: null }],
    },
  ]
}
