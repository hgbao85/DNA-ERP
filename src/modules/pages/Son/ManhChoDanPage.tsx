...
interface SkuGroup {
  /** Khoá gộp PHẢI là id thật (2026-09-11, QA audit C4, đồng bộ KhungHanPage.tsx) - trước đây gộp
   *  theo productName (chuỗi hiển thị), nên khi thiếu plan cho 1 productionOrderId hoặc 2 SKU
   *  trùng tên hiển thị, số liệu các đơn khác nhau bị cộng nhầm chung 1 dòng "Tổng". */
      ...
      <div style={card}>
        <table style={{ width: '100%', borderCollapse: 'collapse', tableLayout: 'fixed' }}>
          ...
          <tbody>
            ...
            {groups.length === 0 && (
              <tr><td colSpan={3} style={{ padding: 32, textAlign: 'center', color: 'var(--text3)' }}><div className="table-empty-msg">Chưa có mảnh nào được KCS duyệt</div></td></tr>
            )}
          </tbody>
          <tfoot>
            <tr style={{ borderTop: '2px solid var(--border)', background: 'var(--surface2)' }}>
