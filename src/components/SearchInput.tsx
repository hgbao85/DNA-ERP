  ...
  return (
    <div style={{ position: 'relative', width: '100%', maxWidth: width }}>
      ...
      <input
        ...
        style={{ paddingLeft: 32, paddingRight: 10, paddingTop: 7, paddingBottom: 7, fontSize: 13, border: '1px solid var(--border)', borderRadius: 8, background: 'var(--surface)', color: 'var(--text)', outline: 'none', width: '100%' }}
