...
const ACTION_ICON: Record<AuditAction, LucideIcon> = {
  ...
  'sku.detail_section_rejected': X,
  'sku.detail_approved':         Send,
  'sku.parts_section_approved':  Check,
  'sku.parts_section_rejected':  X,
  'sku.parts_approved':          Send,
  'sku.qlsx_approved':           Check,
  'sku.sent_for_boss_approval':  Send,
  'sku.qlsx_rejected':           X,
  'sku.boss_approved':           Factory,
  'sku.boss_rejected':           X,
