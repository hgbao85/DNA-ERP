...
const LS_BATCHES = 'san_luong_hs_v1';
const LS_CAPLAI = 'san_luong_hs_caplai_v1';
...
function saveJSON(key: string, v: unknown) {
  try { localStorage.setItem(key, JSON.stringify(v)); } catch { /* SSR / quota */ }
}

function seed(): SanLuongBatch[] {
  return [
    // ── HÀN · đã báo sản lượng, đang chờ KCS ──
    { id: 'h-1', stage: 'HAN', poNumber: 'PO-2026-001', sku: 'GHE-J55', lineId: 121, itemName: 'Ráp chân ghế', spec: 'J55-CHAN', qty: 40, reportedAt: '2026-07-09 09:20', status: 'CHO_KCS' },
    { id: 'h-2', stage: 'HAN', poNumber: 'PO-2026-001', sku: 'GHE-J55', lineId: 131, itemName: 'Hàn giằng ngang', spec: 'J55-GIANG', qty: 50, reportedAt: '2026-07-09 09:35', status: 'CHO_KCS' },
    // ── SƠN · đã báo sản lượng, đang chờ KCS ──
    { id: 's-1', stage: 'SON', poNumber: 'PO-2026-001', sku: 'GHE-J55', lineId: 111, itemName: 'Sơn đen tĩnh điện', spec: 'SN-DEN-01', qty: 15, reportedAt: '2026-07-09 10:05', status: 'CHO_KCS' },
  ];
}
