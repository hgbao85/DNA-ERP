...
export const seedSalesPOs: SalesPO[] = [
  {
    ...
    items: [
      { id: 1, skuCode: 'JSE-55', skuName: 'Ghế J55 (Khung sắt)', totalQty: 200, shippedQty: 200, status: 'HOAN_THANH', deliveryDate: ISO('2026-05-18') },
      { id: 2, skuCode: 'TB-45', skuName: 'Bàn TB-45 (Vuông)', totalQty: 50, shippedQty: 50, status: 'HOAN_THANH', deliveryDate: ISO('2026-05-20') },
    ],
  },
  {
    ...
    items: [
      { id: 3, skuCode: 'SF-10', skuName: 'Ghế sofa SF-10', totalQty: 80, shippedQty: 20, status: 'DAN', deliveryDate: ISO('2026-07-15') },
    ],
  },
  {
    ...
    items: [
      { id: 4, skuCode: 'JSE-60', skuName: 'Ghế J60 (Khung sắt lớn)', totalQty: 300, shippedQty: 300, status: 'HOAN_THANH', deliveryDate: ISO('2026-05-25') },
      { id: 5, skuCode: 'TB-50', skuName: 'Bàn TB-50 (Chữ nhật)', totalQty: 100, shippedQty: 60, status: 'DONG_GOI', deliveryDate: ISO('2026-06-01') },
    ],
  },
  {
    ...
    items: [
      { id: 6, skuCode: 'JSE-55', skuName: 'Ghế J55 (Khung sắt)', totalQty: 500, shippedQty: 0, status: 'MUA_HANG', deliveryDate: ISO('2026-08-30') },
      { id: 7, skuCode: 'TB-45', skuName: 'Bàn TB-45 (Vuông)', totalQty: 200, shippedQty: 0, status: 'KHUNG_CO_KHI', deliveryDate: ISO('2026-08-10') },
      { id: 8, skuCode: 'OUT-30', skuName: 'Bộ bàn ghế ngoài trời OUT-30', totalQty: 50, shippedQty: 10, status: 'CHUYEN_KIEM', deliveryDate: ISO('2026-07-20') },
    ],
  },
  {
    ...
    items: [
      { id: 9, skuCode: 'IEA-3', skuName: 'Ghế đan IEA-3 (Dây đan)', totalQty: 300, shippedQty: 300, status: 'HOAN_THANH', deliveryDate: ISO('2026-04-15') },
    ],
  },
];
